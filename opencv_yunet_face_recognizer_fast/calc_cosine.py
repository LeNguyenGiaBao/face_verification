...
emb_A = np.load('./emb/cv2_emb_a.npy')
emb_B = np.load('./emb/cv2_emb_b.npy')
...
norm_emb_A = norm_emb_A.reshape(1448, 1)
norm_emb_B = norm_emb_B.reshape(1, 1448)
...
# print(df.head())
df.to_csv('./statistics_csv/cv2_cosine_distance.csv', header=None, index=None)
...
plt.savefig('./statistics_chart/cv2_cosine_distance.png')
